...
export function givenCompetitionData(
...
export function givenCompetition(
  data?: Partial<Competition>,
): Promise<Competition> {
  return new CompetitionRepository(new PostgreDataSource()).create(
    givenCompetitionData(data),
  );
}
